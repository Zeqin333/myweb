  ...
  <div id="time">
    <div class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <vue-datetime-picker class="vue-picker1" name="picker1" model="{{@ result1}}">
          </vue-datetime-picker>
        </div>
        <div class="col-sm-4">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <vue-datetime-picker class="vue-picker2" name="picker2" model="{{@ result2}}" type="datetime" language="en" datetime-format="LLL">
          </vue-datetime-picker>
        </div>
        <div class="col-sm-4">
          <p class="form-control-static">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <vue-datetime-picker class="vue-picker3" name="picker3" model="{{@ result3}}" type="date" language="en-US" date-format="L">
          </vue-datetime-picker>
        </div>
        <div class="col-sm-4">
          <p class="form-control-static">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <vue-datetime-picker class="vue-picker4" name="picker4" model="{{@ result4}}" type="time" language="zh-CN" time-format="LT">
          </vue-datetime-picker>
        </div>
        <div class="col-sm-4">
          <p class="form-control-static">
      ...
      <div class="form-group">
        <p class="form-control-static col-sm-12">
          Demonstration of the range of datetime. Note how the minimum/maximum selectable datetime of the start/end datetime picker was changed according to the selection of another picker.
        </p>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-3">
          <vue-datetime-picker class="vue-start-picker" name="start-picker" v-ref="startPicker" model="{{@ startDatetime}}" on-change="{{onStartDatetimeChanged}}">
          </vue-datetime-picker>
        </div>
        ...
        <div class="col-sm-3">
          <vue-datetime-picker class="vue-end-picker" name="end-picker" v-ref="endPicker" model="{{@ endDatetime}}" on-change="{{onEndDatetimeChanged}}">
          </vue-datetime-picker>
        </div>
      </div>
    </div>
